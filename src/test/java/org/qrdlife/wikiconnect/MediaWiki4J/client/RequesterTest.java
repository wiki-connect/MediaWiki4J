...
class RequesterTest {
    ...
    void testEmptyResponseThrows() throws Exception {
        ...
        assertThrows(org.qrdlife.wikiconnect.MediaWiki4J.client.Exception.EmptyResponseException.class,
    ...
    void testApiErrorThrows() throws Exception {
        ...
        assertThrows(org.qrdlife.wikiconnect.MediaWiki4J.client.Exception.UsageException.class,
                () -> requester.get("query", Map.of()));
        response.close();
    }
