...
public class ActionApi {
    ...
    /**
     * Associates an {@link org.qrdlife.wikiconnect.MediaWiki4J.client.Auth.Auth}
     * instance with this API client.
     *
     * @param auth the authentication handler.
     * @return this instance for method chaining.
     */
    public ActionApi setAuth(org.qrdlife.wikiconnect.MediaWiki4J.client.Auth.Auth auth) {
        this.auth = auth;
        if (requester != null) {
    ...
    /**
     * Returns the {@link org.qrdlife.wikiconnect.MediaWiki4J.client.Auth.Auth}
     * instance associated with this API client.
     *
     * @return the authentication handler, or {@code null} if none is set.
     */
    public org.qrdlife.wikiconnect.MediaWiki4J.client.Auth.Auth getAuth() {
        return auth;
    }
